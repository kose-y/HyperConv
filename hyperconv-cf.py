...
#    layer2_input = layer1.output.flatten(2)
    layer2_input = T.concatenate([layer0.output.flatten(2), x.reshape((batch_size, 176, 3, 3))[:, :, 1, 1]], axis=1)
    # construct a fully-connected sigmoidal layer
    layer2 = HiddenLayer(rng, input=layer2_input, n_in=nkerns[0] * 1 * 1 + 176,
    ...
    while (epoch < n_epochs) and (not done_looping):
        ...
        for minibatch_index in xrange(n_train_batches):
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                if this_validation_loss < best_validation_loss or (epoch % 100 == 0 and this_validation_loss == best_validation_loss):
...
#    load_mat_patch()
    ...
    expr = [(100,100), (100,80), (100,60), (100,40), (80,80), (80,60), (80,40), (60,60), (60,40), (40,40),]
    for k,m in expr:
        print k,m
        name="saved_centerfeed_%d_%d" % (k,m)
        evaluate_cnns(data=data, nkerns=[k], n_hidden=m, save_name=name)
